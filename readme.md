...
这是一个 2d 的游戏练习项目，使用 Phaser 框架，教程来自 ourcade 的 Youtube 频道。通过这个教程的练习，可以学习 h5 小游戏开发常用的地图编辑，资源打包等技巧。同时还能学习 状态机 在游戏上的使用。是一个比较典型的小游戏。

我学习这个游戏的原因，是为了更加熟练地掌握 Phaser 框架。

## 依赖软件：

1. Tiled 地图编辑软件。开源，免费
2. TexturePacker 图片资源打包工具。有免费版本
